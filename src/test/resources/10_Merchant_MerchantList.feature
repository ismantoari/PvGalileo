...
# Edit merchant list
  ...
  Scenario: Edit Merchant Single
    ...
    And user click combo box predefine "Merchant Type" and select value "Food"
    And user click combo box predefine "Merchant Parent" and select value "Toma's Brasserie"
#    And user click combo box predefine "Location" and select value "Chillax"
#    And user input text area predefine "Address" with value "this is a new address"
#    And user click combo box predefine "Postal Code *" and select value "12313"
#    And user click combo box predefine "Bank *" and select value "BNI"
#    And user input text box predefine "Bank Account Number *" with value "23114112"
    ...
    Then show alert pop up "Update merchant data success"
...
# Add Existing Merchant Name with the same Location
  ...
  Scenario: Add Existing Merchant Name with the same Location
    ...
    When user click button "Add Merchant"
    Then show alert pop up "Merchant alredy registered"
